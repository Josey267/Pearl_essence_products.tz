    ...
    agentsLink.addEventListener('click', (e) => {
      e.preventDefault();
      // Scroll to agent process section if on main content
      if (mainContent.style.display === 'block') {
        document.querySelector('.agent-process').scrollIntoView({ behavior: 'smooth' });
      } else {
        alert("Our agents will contact you shortly. Please call +255 754 757 065 for immediate assistance.");
      }
    });
